...
class Branches extends Model
{
    ...
    public static function getBranchParent()
    {
        // return Cache::remember('branch', Helper::CACHE_TIME_LIVE, function () {
            return static::whereNull('parent_id')->get();
        // });
    }
    public static function getBranchChild()
    {
        // return Cache::remember('branch', Helper::CACHE_TIME_LIVE, function () {
            return static::where('is_active', 1)->whereNotNull('parent_id')->orderBy('position', 'desc')->get();
        // });
    }
