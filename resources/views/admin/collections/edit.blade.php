...
@section('content')
    <div class="row">
        <div class="col-md-12">
            <div class="mb-3 card">
                <form autocomplete="off" action="{{ route('admin.collections.update', $collection->id) }}" method="post">
                    @csrf
                    @method('PUT')
                                ...
                                <div class="form-row">
                                    <div class="col-md-6">
                                        <div class="position-relative form-group">
                                            ...
                                            <select name="key_collection" required class="form-control" id="key_collection">
                                                @foreach(\App\Http\Controllers\Helper::COLLECTION_KEY as $key => $name)
                                                    <option @if ($collection->key_collection === $key)
                                                            selected
                                ...
                                <div class="form-row">
                                    <div class="col-md-6" style="float: left;">
                                        <div class="position-relative form-group">
                                            ...
                                            <input type="number" value="{{ $collection->display_order }}" class="form-control" name="display_order">
                                        </div>
                                    </div>
                                    <div class="col-md-6" style="float: left;">
                                        <div class="position-relative form-group">
                                            ...
                                            <input type="checkbox" id="is_active" name="is_active"
                                                   @if($collection->is_active == 'on') checked @endif
                                    ...
                                    <div class="col-md-12">
                                        <div class="position-relative form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="text" required name="image" value="{{ $collection->image }}" id="image_label"
                                                       class="form-control">
                                                ...
                                                @if(isset($collection->image))<img width="100px" style="border: 1px solid red"
                                                                            src="{{ $collection->image }}" alt="">@endif
                                            </div>
                                        </div>
                                    </div>
                                </div>
