...
@php($linkCreate = route('admin.slides.create'))
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form id="{{ 'destroy-form-' . $item->id }}"
                                              action="{{ route('admin.slides.destroy',  $item->id) }}"
